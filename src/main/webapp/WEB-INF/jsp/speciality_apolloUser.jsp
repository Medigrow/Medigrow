...
<div class="spec">
<h2 style="font-weight: bold;"> Centres of Excellence</h2>
                <p>Appo Hospitals has dedicated Centers of Excellence for several key specialties and superspecialties. They are unique and state of the art facilities spread across several of the Appo hospital location and each Centre of Excellence stands out as a citadel of excellence.
...
<div class="container1">
  <div class="content">
      ...
      <img class="content-image" src="/Images/heart.jpg">
      <div class="content-details fadeIn-bottom">
        <h3 class="content-title">Cardiology</h3>
        <p class="content-text">Our team of cardiologists and cardiothoracic surgeons are trained at the top institutes in India and abroad and are completely dedicated to the treatment for coronary heart diseases.</p>
      </div>
  </div>
</div>
<div class="container1">
...
Robotic Surgery is a method to perform surgery using very small tools attached to a robotic arm. The surgeon controls the robotic arm with a computer. </p>
      </div>
  </div>
</div>
<div class="container1">
  <div class="content">
      ...
      <div class="content-details fadeIn-bottom">
        ...
        <p class="content-text">Appo has set up a walk-in facility for COVID-19 swab collection testing,
