...
<div class="speciality_container">
                <h2 style="font-weight: bold;" contenteditable="true"> Facilities</h2>
                <p contenteditable="true">Appo Hospitals has dedicated Facilities for several key specialties and super specialties. They are unique and state of the art facilities spread across several of the Apollo hospital location and each Facility stands out as a citadel of excellence.

                   </p>
    <div class=grid>
        <div class="btns"style="float:left;">
        <button type="button" class="facilitybtn" style="background-image: url('/Images/trauma1.jpg');  border: 1.5px solid #1589FF;border-radius: 2px; background-repeat: no-repeat; background-size: cover;">
        ...
        <div class="btns">
        <button type="button" class="facilitybtn" style="background-image: url('/Images/ambulance.jpg'); border: 1.5px solid #C34A2C;border-radius: 2px;background-repeat: no-repeat; background-size: cover;">
        ...
        <div class="btns">
        <button type="button" class="facilitybtn" style="background-image: url('/Images/emergency-2.jpg'); border: 1.5px solid #1589FF;border-radius: 2px;background-repeat: no-repeat; background-size: cover;">
        ...
        <div class="btns" style="float:left;">
                <button type="button" class="facilitybtn" style="background-image: url('/Images/tpa.jpg'); border: 1.5px solid #fff;border-radius: 2px;background-repeat: no-repeat; background-size: cover;">
		 ...
		 <div class="btns" style="float:left;">
                <button type="button" class="facilitybtn" style="background-image: url('/Images/covidcare.jpg'); border: 1.5px solid #E8A317;border-radius: 2px;background-repeat: no-repeat; background-size: cover;">
                ...
                <div class="btns" style="float:left;">
                                <button type="button" class="facilitybtn" style="background-image: url('/Images/scan.jpg'); border: 1.5px solid #43BFC7;border-radius: 2px;background-repeat: no-repeat; background-size: cover;">
