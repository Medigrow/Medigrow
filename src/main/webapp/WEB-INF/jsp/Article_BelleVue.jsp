...
<div class= "article_user">
                ...
                <div class= "article_user">
                     <h2 contenteditable="true">Implications of public policy on breast reconstruction: a survey of New York State breast
                     surgeons on the breast cancer provider discussion law.</h2>
                     <p contenteditable="true">Nearly 1 in 8 women in the U.S. develop breast cancer (1). Mastectomy, including prophylactic mastectomy, is an ever-important treatment option, but leaves women disfigured. Breast reconstruction is an accepted component of the complete multidisciplinary care of the breast cancer patient due to its substantial psychological benefit and contribution to improved quality of life (2-5). Its significance is reflected in the Women&#39;s Health and Cancer Rights Act (1998) which mandated that breast reconstruction be covered under insurance. Despite incremental increases, subsequent studies revealed that reconstruction rates have remained low with a national estimate of 42% (6).
                     </p>
                     <a href="javascript:void();"class="myBtn">Read More</a>
                     </div>
