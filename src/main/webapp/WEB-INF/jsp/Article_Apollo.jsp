...
<div class= "article_user">
                    ...
                    <h2 contenteditable="true">Appo Hospitals, Chennai has successfully implanted the first and the world&#180;s largest Artificial
                    Pulmonary Valve without surgery on a 61-year-old patient.</h2>
                    <p contenteditable="true">Doctors at Appo Hospitals, Chennai successfully implanted the first and the world&#180;s
                ...
                <div class= "article_user">
                     <h2 contenteditable="true">Appo Hospitals, Indore has successfully performed Central India&#180;s first Renal Denervation
                     ...
                     <a href="javascript:void();"class="myBtn">Read More</a>
                      ...
                      <div class= "article_user">
                                ...
                                <h2 contenteditable="true">Appo Hospitals Group has launched Post-COVID Recovery Clinics to help patients deal with the aftermath of COVID-19
                                and restore their health.</h2>
                                <p contenteditable="true">The Appo Hospitals Group has launched Post-COVID Recovery Clinics across the hospital
