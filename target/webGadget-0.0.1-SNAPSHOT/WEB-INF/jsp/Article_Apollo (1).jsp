        ...
        <div class="container">
                        ...
                        <button type="button" class="button1">
                                                         <a href= "video_apollo">Videos</a></button>
                                                            ...
                                                            <a href= "Article_Apollo">Articles</a></button>
                </div>
<div class= "article_user">

                    <h2 contenteditable="true">Apollo Hospitals, Chennai has successfully implanted the first and the world&#180;s largest Artificial
                    Pulmonary Valve without surgery on a 61-year-old patient.</h2>
                    <p contenteditable="true">Doctors at Apollo Hospitals, Chennai successfully implanted the first and the world&#180;s
                ...
                <div class= "article_user">
                     <h2 contenteditable="true">Apollo Hospitals, Indore has successfully performed Central India&#180;s first Renal Denervation
                     Therapy for treating uncontrollable hypertension.</h2>
                     <p contenteditable="true">Mr. Elkaaar Singh Rajput, 56-year-old male
                     ...
                     He approached Apollo Hospitals, Indore for treatment of his blood pressure. He successfully
                     ...
                     <a href="javascript:void();"class="myBtn">Read More</a>
                      ...
                      <div class= "article_user">
                                ...
                                <h2 contenteditable="true">Apollo Hospitals Group has launched Post-COVID Recovery Clinics to help patients deal with the aftermath of COVID-19
                                and restore their health.</h2>
                                <p contenteditable="true">The Apollo Hospitals Group has launched Post-COVID Recovery Clinics across the hospital
                                ...
                                the Post-COVID Recovery Clinic will be conducted at the Apollo Hospitals, Greams Road, Chennai.
                                Ms. Preetha Reddy, Vice Chairperson, Apollo Hospitals Group, said, &#8220;We had realized early on that addressing the COVID challenge would require a comprehensive response plan and had launched
