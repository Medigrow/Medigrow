...
<div class="vi_container">
        <div class="container">
                        ...
                        <button type="button" class="button1">
                                                         <a href= "video_ashwini">Videos</a></button>
                                                            <button type="button" class="button2">
                                                            <a href= "Article_Ashwini">Articles</a></button>
                </div>
<div class= "article_user">

                    <h2 contenteditable="true">Challenges experienced with the implementation of telecourt for psychiatric involuntary commitment hearings in the coronavirus disease 2019 pandemic</h2>
                    <p contenteditable="true">The unprecedented outbreak of the coronavirus 2019 (COVID-19) pandemic has been a catalyst for an overnight transition to telehealth services across heath care systems.
                ...
                <div class= "article_user">
                     <h2 contenteditable="true">Challenges in health technology assessments of genetic tests</h2>
                     <p contenteditable="true">Genetic tests (including genomic tests) detect changes in chromosomes, genes, or proteins (1). With the current increasing availability of
                     ...
                     <a href="javascript:void();"class="myBtn">Read More</a>
                      ...
                      <div class= "article_user">
                                ...
                                <h2 contenteditable="true">Hospital patient attitudes regarding cancer prevention policies focusing on processed meats: a survey of patients in high- and low-income areas.</h2>
                                <p contenteditable="true">In 2015, the World Health Organization determined that processed meats cause colorectal cancer (1). These products include meats that have been transformed through salting, curing,
