...
<header>
    ...
    <p data-aos="fade-up">
    <b>Registered Address:</b> 124, street Road Kalyan, Mumbai 510024<br>
...
<img src="<%=request.getContextPath()%>/Images/hospital_Ashwini-bodyimg.jpg" style="float:left" class="figure-img img-fluid z-depth-1"
    alt="..." style="width:250px;" class="responsive">
  <h4 style="text-align:left; margin-left: 610px;" data-aos="fade-up"><b>Vision</b></h4>
  <p style="text-align:left; margin-left: 610px;" data-aos="fade-up">
  ...
  <h4 style="text-align:left; margin-left: 610px;" data-aos="fade-up"><b>Mission</b></h4>
  <p style="text-align:left; margin-left: 610px;" data-aos="fade-up">
