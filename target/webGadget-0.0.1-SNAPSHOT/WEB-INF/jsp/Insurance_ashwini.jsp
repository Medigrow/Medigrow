...
<div class="insurance_container">
        <h2 contenteditable="true">Emergency Hospitalization</h2>
        <p contenteditable="true">In case of emergency hospitalization, the corporate help desk will take up your case on a fast track basis with your TPA and is likely to receive approvals within 3 hours during any working day.
        ...
        <h2 contenteditable="true">Who is the TPA&#180;s with whom Ashwin Hospital has a tie-up?</h2>
        <p contenteditable="true">Ashwin Hospital has a tie-up with several TPA&#180;s. (Current list is given below). However this is dynamic and will change from time to time.<p>
        ...
        <div class="TPA">
        			...
        			<table>
                                          ...
                                          <tr>
                                            <td>2</td>
                                            <td><a href="#">Astha Ombard General Insurance Co. Ltd.</a></td>
                                             <td>Available</td>
                                          </tr>
                                            <tr>
                                                 <td>3</td>
                                                 <td><a href="#">TCG Medcorp Pvt. Ltd.</a></td>
                                                  <td>Available</td>
                                            </tr>
                                        </table>
        </div>
