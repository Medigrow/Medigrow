...
<div class="insurance_container">
        ...
        <h2 contenteditable="true">Who is the TPA&#180;s with whom BeleVe Clinic has a tie-up?</h2>
        <p contenteditable="true">BeleVe Clinic has a tie-up with several TPA&#180;s. (Current list is given below). However this is dynamic and will change from time to time.<p>
