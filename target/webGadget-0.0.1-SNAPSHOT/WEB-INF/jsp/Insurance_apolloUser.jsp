...
<div class="insurance_container">
        <h2>Do all Health Insurance Policies offer cashless hospitalization facility?</h2>
        <p>Today, most Health Insurance policies do offer cashless hospitalization facility and route your policy through a Third party Administrator (TPA). However you should be familiar with the terms- Network Hospital and Non-network Hospital.

           Network Hospitals are those hospitals that your TPA has an agreement with. In case of hospitalization, if you get admitted to a Network Hospital you will be eligible for cashless hospitalization, subject to the other terms and conditions mentioned in your policy being fulfilled. In case you are admitted to a Non-network Hospital, you will have to settle
           the bills directly to the hospital and then seek re-imbursement through your TPA.</p>
        ...
        <h2>Who is the TPA&#180;s with whom Appo Hospitals has a tie-up?</h2>
        <p>Appo Hospitals has a tie-up with several TPA&#180;s. (Current list is given below). However this is dynamic and will change from time to time.<p>
